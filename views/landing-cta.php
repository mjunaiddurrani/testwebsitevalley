...
<div class="ys-container mycustompop " id="ys-container">
  <div class="ys-box">
    <a class="ys-popup-close ys-exit closePopup" style="cursor:pointer;">x</a>
          ...
          <div class="boxednav">
            ...
            <div class="navigation">
              ...
              <ul class="infochannel">
                <li><a class="numbercta formBtn" href="javascript:void(0);"><span class="icon-phone2"></span>Get a call</a></li>
                <li><a href="javascript:void(0)" class="btn-primary formBtn">Get a quote</a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class=" col-lg-6">
                    <div class="home-banner-content">
                      ...
                      <div class="btn-wrap">
                        <a href="javascript:;"  class="formBtn btn-primary" >Get Started</a>
                        <a href="javascript:void(0);" class="btn-secondary-outline formBtn">Get Your website now</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="btnwrap">
            <a href="javascript:;"  class="btn-primary formBtn">Chat With Us</a>
            <a href="javascript:;" class="btn-secondary-outline formBtn" tabindex="0">Get in Touch</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <a data-fancybox="port" href="images/web-9.jpg">
      <figure>
        <img src="images/web-9.jpg" alt="">
            ...
            <div class="btn-wrap">
              <a href="javascript:void(0);" class="btn-primary formBtn">Request More Portfolio</a>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="textwrap">
            ...
            <div class="btn-wrap">
              <a href="javascript:void(0)"  class="btn-secondary formBtn">Let's Chat</a>
          ...
          <div class="combopackwrap">
            ...
            <div class="footterr">
              <div class="left">
                ...
                <div class="btnwrap">
                  <a class="numbercta formBtn" href="javascript:void(0);">Get In Touch</a>
                  <a class="chatcta formBtn" href="javascript:;" >chat</a>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="textwrap">
            ...
            <div class="btn-wrap">
              <a href="javascript:;" class="formBtn btn-primary">Chat Now</a>
              <a href="javascript:;" class="formBtn btn-secondary-outline">Request a Call</a>
            </div>
          </div>
        </div>
      </div>
