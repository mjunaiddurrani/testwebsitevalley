...
<head>
  ...
  <title>TAKE A LOOK AT WHAT WE WOULD DO FOR YOUR BRAND.</title>

  <meta name="description" content="Check out all of our best and recent projects and know what we may also do for making your brand successful among your competitors.">
...
<body class="services">
  ...
  <section class="section1" style="background: url('images/banner/portfolio.jpg');">
    <div class="overlay"></div>
    <div class="container z-index-9 position-relative">
      <div class="text-center">
        <h1 class="text-white font-60 font-w800">Let us walk you through our creative corridor.</h1>
      </div>
    </div>
  </section>
...
<?php include('include/portfolio.php');?>
    ...
    <section class="py-5">
	  <div class="container text-dark">
        ...
        <div class="col-md-6">
          <div class="row">
            <p class="text-secondary font-w300 line-height-32 font-22 p-5">Our services are unrivalled by anyone in the market, and the same goes for our plans. Get the most out of what we offer.</p>
          </div>
        </div>
      </div>
	  	<div class="row">
