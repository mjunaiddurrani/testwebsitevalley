...
<title>BEGINNERS E-COMMERCE PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Beginners E-Commerce Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Beginners E-Commerce<br> Package</h3>
          <h6><span class="old">£<?= cutPrice($beginnersEcommerce);?></span>  £<?= $beginnersEcommerce?>    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for small startups who are looking to sell products online.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <div class="contentScroll innerContentScroll">
                ...
                <p>Up To 100 Products <i class="fa fa-check "></i></p>
                <p>Up To 7 Categories <i class="fa fa-check "></i></p>
                ...
                <p>FREE 1 Years Hosting <i class="fa fa-check "></i></p>
