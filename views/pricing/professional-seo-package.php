...
<title>PROFESSIONAL SEO PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Professional SEO Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Professional SEO <br>Packages</h3>
          <h6><span class="old">£4300</span>  £2150   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list">
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <p>30 Keywords <i class="fa fa-check "></i></p>
              <p>Guaranteed Ranking on Google <i class="fa fa-check "></i></p>
              <p>Off-site Optimization <i class="fa fa-check "></i></p>
              <p>On-site Optimization <i class="fa fa-check "></i></p>
              <p>Link Building <i class="fa fa-check "></i></p>
              <p>Social Bookmarking <i class="fa fa-check "></i></p>
              <p>In-depth Site Analysis <i class="fa fa-check "></i></p>
              <p>Content Duplicacy Check <i class="fa fa-check "></i></p>
              <p>Initial Backlinks analysis <i class="fa fa-check "></i></p>
              <p>Google Penalty Check <i class="fa fa-check "></i></p>
              <p>Mobile Usability Check <i class="fa fa-check "></i></p>
              <p>Competition Analysis <i class="fa fa-check "></i></p>
              <p>Keyword Research <i class="fa fa-check "></i></p>
              <p>Page Speed Analysis &amp; Optimization <i class="fa fa-check "></i></p>
              <p>Title &amp; Meta Tags Optimization <i class="fa fa-check "></i></p>
              <p>Content Optimization <i class="fa fa-check "></i></p>
              <p>HTML Code Cleanup &amp; Optimization <i class="fa fa-check "></i></p>
              <p>Internal Link Structuring &amp; Optimization <i class="fa fa-check "></i></p>
              <p>Pages H tags Optimization <i class="fa fa-check "></i></p>
              <p>Canonicalization/301 Redirect <i class="fa fa-check "></i></p>
              <p>Website Page Load Optimization <i class="fa fa-check "></i></p>
              <p>Robots.txt Creation/Analysis <i class="fa fa-check "></i></p>
              <p>Press Release Writing &amp; Distribution <i class="fa fa-check "></i></p>
              <p>Press Release Social Bookmarking <i class="fa fa-check "></i></p>
              <p>Schema Markup Implementation <i class="fa fa-check "></i></p>
              <p>Image &amp; Hyperlink Optimization <i class="fa fa-check "></i></p>
              <p>Google Webmaster Tools Setup <i class="fa fa-check "></i></p>
              <p>Google Analytics Setup &amp; Integration <i class="fa fa-check "></i></p>
              <p>Blog Writing (2 - Per Month) <i class="fa fa-check "></i></p>
              <p>Informational Content Writing &amp; Sharing (1 Per Month) <i class="fa fa-check "></i></p>
              </div>
            </div>
          </div>
        </div>
