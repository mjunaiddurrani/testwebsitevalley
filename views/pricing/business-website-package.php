...
<title>BUSINESS WEBSITE PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Business Website Package</h2>
      </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£<?= cutPrice($businessWebsite);?></span>  £<?= $businessWebsite?>   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for mid sized startups who are looking to work with a strong R&D, Creative and marketing team to help develop a unique brand identity, strong digital presense, marketing strategies and help select elements to alter consumer behaviour toawrds their business. These strategies will help to compete directly with some of the top competitors in your target market.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          <p class="">Custom Made, Interactive, Dynamic &amp; High End Design <i class="fa fa-check"></i></p>
                          <p class="">Custom WP (or) Custom PHP Development <i class="fa fa-check"></i></p>
                          <p class="">1 jQuery Slider Banner <i class="fa fa-check"></i></p>
                          <p class="">Up to 10 Custom Made Banner Designs <i class="fa fa-check"></i></p>
                          <p class="">10 Stock Images <i class="fa fa-check"></i></p>
                          <p class="">Unlimited Revisions <i class="fa fa-check"></i></p>
                          <p class="">Special Hover Effects <i class="fa fa-check"></i></p>
                          <p class="">Content Management System (CMS) <i class="fa fa-check"></i></p>
                          <p class="">Online Appointment/Scheduling/Online Ordering Integration (Optional) <i class="fa fa-check"></i></p>
                          <p class="">Online Payment Integration (Optional) <i class="fa fa-check"></i></p>
                          <p class="">Multi Lingual (Optional) <i class="fa fa-check"></i></p>
                          <p class="">Custom Dynamic Forms (Optional) <i class="fa fa-check"></i></p>
                          <p class="">Signup Area (For Newsletters, Offers etc.) <i class="fa fa-check"></i></p>
                          <p class="">Search Bar <i class="fa fa-check"></i></p>
                          <p class="">Live Feeds of Social Networks integration (Optional) <i class="fa fa-check"></i></p>
                          <p class="">Mobile Responsive <i class="fa fa-check"></i></p>
                          <p class="">15 Seconds 2D Explainer Video <i class="fa fa-check"></i></p>
                          <p class="">Voice - Over &amp; Sound Effects <i class="fa fa-check"></i></p>
                          <p class="">Professional Script Writing <i class="fa fa-check"></i></p>
                          <p class="">Storyboard <i class="fa fa-check"></i></p>
                          <p class="">SEO Meta Tags <i class="fa fa-check"></i></p>
                          <p class="">FREE 5 Years Domain Name <i class="fa fa-check"></i></p>
                          ...
                          <p class="">Industry Specified Team of Expert Designers and Developers <i class="fa fa-check"></i></p>
