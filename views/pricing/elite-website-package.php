...
<title>ELITE WEBSITE PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£1600</span>  £749   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for basic startups looking to take it one step at a time.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          <p class=""> Upto 15 Unique Pages Website <i class="fa fa-check "></i></p>
                          ...
                          <p class=""> Striking Hover Effects <i class="fa fa-check "></i></p>
                          <p class=""> Newsletter Subscription (Optional) <i class="fa fa-check "></i></p>
                          ...
                          <p class=""> 5 Stock Photos <i class="fa fa-check "></i></p>
                          <p class=""> 3 Unique Banner Design <i class="fa fa-check "></i></p>
                          <p class=""> 1 jQuery Slider Banner <i class="fa fa-check "></i></p>
                          <p class="">  Complete W3C Certified HTML <i class="fa fa-check "></i></p>
                          <p class=""> 48 to 72 hours TAT <i class="fa fa-check "></i></p>
