...
<title>CLASSIC VIDEO PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Classic Video <br> Package</h2>
      </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£800</span>  £400   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                        <p class="">60 Second Video - HD 1080 <i class="fa fa-check"></i></p>
                        ...
                        <p class="">5 weeks Delivery <i class="fa fa-check"></i></p>
