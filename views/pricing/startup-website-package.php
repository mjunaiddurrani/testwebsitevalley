...
<title>STARTUP WEBSITE PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£400</span>  £199   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for static based landing pages.</span></h6>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list contentScroll innerContentScroll">
                <li>
                  <h6>5 Stock Photos</h6>
                ...
                <li>
                  <h6>3 Banner Design</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>1 jQuery Slider Banner</h6>
                  <span class="tick"></span>
                </li>
                ...
                <li>
                  <h6>Mobile Responsive will be Additional £99*</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>CMS will be Additional £149*</h6>
                  <span class="tick"></span>
                </li>
                <li>
