...
<title>STARTUP COMBO PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£<?= cutPrice($startupCombo);?></span>  £<?= $startupCombo?>   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          <p class="">Unlimited Logo Design Concepts <i class="fa fa-check"></i></p>
                          <p class="">+ Social Media Design <i class="fa fa-check"></i></p>
                          <p class="">Mobile Responsive <i class="fa fa-check"></i></p>
                          <p class="">3 Dedicated Designers <i class="fa fa-check"></i></p>
                          <p class="">Icon Design <i class="fa fa-check"></i></p>
                          <p class="">Business Card, Letterhead, Envelope <i class="fa fa-check"></i></p>
                          ...
                          <p class="">5 Stock Photos + 3 Banner Designs <i class="fa fa-check"></i></p>
