...
<title>ELITE E-COMMERCE PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Elite E-Commerce Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£<?= cutPrice($eliteEcommerce);?></span>  £<?= $eliteEcommerce?>   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for mid sized startups/enterprises who are looking to take it on the next level </span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <div class="contentScroll innerContentScroll">
                <p>By 6 Award Winning Designers <i class="fa fa-check "></i></p>
                <p>Icon Design <i class="fa fa-check "></i></p>
                <p>UNLIMITED Revisions <i class="fa fa-check "></i></p>
                <p>Print Media <i class="fa fa-check "></i></p>
                <p>Stationary Design (BusinessCard,Letterhead &amp; Envelope) <i class="fa fa-check "></i></p>
                <p>Invoice Design, Email Signature <i class="fa fa-check "></i></p>
                <p>Bi-Fold Brochure (OR) 2 Sided Flyer Design <i class="fa fa-check "></i></p>
                <p>Product Catalog Design <i class="fa fa-check "></i></p>
                <p>Signage Design (OR) Label Design <i class="fa fa-check "></i></p>
                <p>T-Shirt Design (OR) Car Wrap Design <i class="fa fa-check "></i></p>
                <p>Website <i class="fa fa-check "></i></p>
                <p>E-Commerce Store Design <i class="fa fa-check "></i></p>
                <p>Product Detail Page Design <i class="fa fa-check "></i></p>
                <p>Unique Banner Slider <i class="fa fa-check "></i></p>
                <p>Featured Products Showcase <i class="fa fa-check "></i></p>
                <p>Full Shopping Cart Integration <i class="fa fa-check "></i></p>
                <p>Unlimited Products <i class="fa fa-check "></i></p>
                <p>Unlimited Categories <i class="fa fa-check "></i></p>
                <p>Product Rating &amp; Reviews <i class="fa fa-check "></i></p>
                <p>Easy Product Search <i class="fa fa-check "></i></p>
                <p>Payment Gateway Integration <i class="fa fa-check "></i></p>
                <p>Multi-currency Support <i class="fa fa-check "></i></p>
                <p>Content Management System <i class="fa fa-check "></i></p>
                <p>Customer Log-in Area <i class="fa fa-check "></i></p>
                <p>Mobile Responsive <i class="fa fa-check "></i></p>
                <p>Social Media Plugins Integration <i class="fa fa-check "></i></p>
                <p>Tell a Friend Feature <i class="fa fa-check "></i></p>
                <p>Social Media Pages <i class="fa fa-check "></i></p>
                <p>Facebook , Twitter, YouTube, Google+ &amp; Pinterest Page Designs <i class="fa fa-check "></i></p>
                <p>Value Added Services <i class="fa fa-check "></i></p>
                <p>Dedicated Account Manager <i class="fa fa-check "></i></p>
                <p>Unlimited Revisions <i class="fa fa-check "></i></p>
                <p>All Final File Formats <i class="fa fa-check "></i></p>
              </div>
            </div>
          </div>
        </div>
