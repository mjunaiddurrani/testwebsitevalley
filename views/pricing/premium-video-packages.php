...
<title>PREMIUM VIDEO PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£1400</span>  £700   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                        <p class="">90 Second Video - HD 1080 <i class="fa fa-check"></i></p>
                        <p class="">Professional Script <i class="fa fa-check"></i></p>
                        <p class="">Sample Theme <i class="fa fa-check"></i></p>
                        <p class="">Storyboard <i class="fa fa-check"></i></p>
                        <p class="">Animation <i class="fa fa-check"></i></p>
                        <p class="">Voice - Over &amp; Sound Effects <i class="fa fa-check"></i></p>
                        <p class="">6 Weeks Delivery <i class="fa fa-check"></i></p>
