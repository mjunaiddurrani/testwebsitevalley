...
<title>STARTUP SEO PACKAGES - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Startup SEO Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Startup SEO <br>Packages</h3>
          <h6><span class="old">£900</span>  £450   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <p>5 Keywords <i class="fa fa-check "></i></p>
              ...
              <p>Basic Analytical Report <i class="fa fa-check "></i></p>
              <p>In-depth Site Analysis <i class="fa fa-check "></i></p>
              <p>Content Duplicity Check <i class="fa fa-check "></i></p>
              ...
              <p>Informational Content Writing &amp; Sharing (2 - Per Month) <i class="fa fa-check "></i></p>
              <p>Blog Writing (1 - Per Month) <i class="fa fa-check "></i></p>
              <p>Press Release Social Bookmarking (5 - Per Month) <i class="fa fa-check "></i></p>
              <p>NAP Syndication <i class="fa fa-check "></i></p>
              <p>Google My Business / Bing Local Listing <i class="fa fa-check "></i></p>
              <p>Citation Building <i class="fa fa-check "></i></p>
              <p>Classified Submissions <i class="fa fa-check "></i></p>
              <p>Google Analytics Analysis Report <i class="fa fa-check "></i></p>
              <p>SEO Reports <i class="fa fa-check "></i></p>
              <p>Search Engine Rank Report <i class="fa fa-check "></i></p>
              <p>Dedicated Accounts Manager <i class="fa fa-check "></i></p>
              <p>Monthly Action Plan <i class="fa fa-check "></i></p>
              <p>Activity Report <i class="fa fa-check "></i></p>
              </div>
            </div>
          </div>
        </div>
