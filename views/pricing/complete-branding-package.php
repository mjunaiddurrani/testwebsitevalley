...
<title>COMPLETE BRANDING SOLUTION - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Complete Branding Solution</h3>
          <h6><span class="old">£1990</span>  £995   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <p>Unlimited Custom Logo Design Concepts <i class="fa fa-check "></i></p>
              <p>6 Dedicated Designers <i class="fa fa-check "></i></p>
              <p>UNLIMITED Pages Website <i class="fa fa-check "></i></p>
              <p>Mobile Responsive <i class="fa fa-check "></i></p>
              <p>Icon Design <i class="fa fa-check "></i></p>
              <p>Business Card, Letterhead, Envelope <i class="fa fa-check "></i></p>
              <p>MS Word Letterhead <i class="fa fa-check "></i></p>
              <p>5 Stock Photos + 3 Banner Designs <i class="fa fa-check "></i></p>
              ...
              <p>100% Ownership Rights <i class="fa fa-check "></i></p>
              <p>100% Satisfaction Guarantee <i class="fa fa-check "></i></p>
