...
<title>UNLIMITED COLLATERAL PACKAGES - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Unlimited Collateral Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Unlimited Collateral Packages</h3>
          <h6><span class="old">£500</span>  £250   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <p>2 Stationery Design Set <i class="fa fa-check "></i></p>
              <p>Menu Card Design <i class="fa fa-check "></i></p>
              <p>T-Shirt Design <i class="fa fa-check "></i></p>
              <p>1 Banner Design <i class="fa fa-check "></i></p>
              </div>
            </div>
          </div>
        </div>
