...
<title>BASIC COMBO PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Basic Combo <br>Packages</h2>
      </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Basic Combo <br>Packages</h3>
          <h6><span class="old">£<?= cutPrice($basicCombo);?></span>  £<?= $basicCombo?>   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          <p class="">5 Custom Logo Design Concepts <i class="fa fa-check"></i></p>
                          <p class="">By 2 Designers <i class="fa fa-check"></i></p>
                          <p class=""> Icon Design <i class="fa fa-check"></i></p>
                          <p class="">Business Card, Letterhead, Envelope, Fax Template <i class="fa fa-check"></i></p>
                          <p class="">MS Word Letterhead <i class="fa fa-check"></i></p>
                          <p class="">5 Page Website <i class="fa fa-check"></i></p>
                          <p class="">Mobile Responsive <i class="fa fa-check"></i></p>
                          <p class="">Team of Expert Designers &amp; Developers <i class="fa fa-check"></i></p>
                          <p class="">8 Stock images <i class="fa fa-check"></i></p>
                          <p class="">5 Banner Designs <i class="fa fa-check"></i></p>
