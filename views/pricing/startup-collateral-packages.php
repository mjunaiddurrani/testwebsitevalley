...
<title>STARTUP COLLATERAL PACKAGES - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Startup Collateral Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Startup Collateral<br> Packages</h3>
          <h6><span class="old">£100</span>  £50   <!-- <b>USD</b> --> <span class=""><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <div class="contentScroll innerContentScroll">
                ...
                <p>FREE Fax Template <i class="fa fa-check "></i></p>
                <p>Print Ready Formats <i class="fa fa-check "></i></p>
