...
<title>PREMIUM COLLATERAL PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Premium Collateral Packages</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Premium Collateral Packages</h3>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <p>Packaging Design <i class="fa fa-check "></i></p>
