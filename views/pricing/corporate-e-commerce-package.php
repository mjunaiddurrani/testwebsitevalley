...
<title>CORPORATE E-COMMERCE PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Corporate E-Commerce Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Corporate E-Commerce<br> Package</h3>
          <h6><span class="old">£<?= cutPrice($corporateEcommerce);?></span>  £<?= $corporateEcommerce?>   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for strong startups looking to create a client base and develop a unique brand identity to help them stand apart from their competitors.</span></h6>
