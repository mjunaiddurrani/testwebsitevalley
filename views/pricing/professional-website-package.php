...
<title>PROFESSIONAL WEBSITE PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£1000</span>  £449    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for basic startups looking to take it one step at a time.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list contentScroll innerContentScroll">
                <li>
                  <h6>10 Page Website</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>CMS / Admin Panel Support</h6>
                  <span class="tick"></span>
                </li>
