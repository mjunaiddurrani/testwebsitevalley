...
<title>PROFESSIONAL COMBO PACKAGE - THE WEB FOUNDERS</title>
...
>>>>>>> 74a37f28d04dc4e2dffb253f8c7bbf1030c77a0b
=======
<
<link rel="icon" href="favicon.ico" type="image/x-icon" />
<link href="/css/m-style.css" rel="stylesheet" type="text/css" />
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Professional Combo Packages</h2>
      </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Professional Combo <br>Packages</h3>
          <h6><span class="old">£<?= cutPrice($professionalCombo); ?></span>  £<?= $professionalCombo ?>   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          ...
                          <p class="">Trifold Brochure Design <i class="fa fa-check"></i></p>
                          <p class="">Presentation Folder Design <i class="fa fa-check"></i></p>
                          <p class="">Conceptual and Dynamic Liquid Website <i class="fa fa-check"></i></p>
                          <p class="">Team of Expert Designers &amp; Developers <i class="fa fa-check"></i></p>
                          <p class="">Mobile Responsive <i class="fa fa-check"></i></p>
                          <p class="">Online Reservation/Appointment Tool (Optional) <i class="fa fa-check"></i></p>
                          ...
                          <p class="">15 Stock images <i class="fa fa-check"></i></p>
                          <p class="">8 Unique Banner Designs <i class="fa fa-check"></i></p>
                          <p class="">jQuery Sliders <i class="fa fa-check"></i></p>
