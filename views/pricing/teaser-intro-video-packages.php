...
<title>TEASER/INTRO VIDEO PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Teaser/Intro Video Package</h2>
      </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£300</span>  £150   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for potential startups and brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                        <p class="">15s Duration - HD 1080 <i class="fa fa-check"></i></p>
                        <p class="">Professional Script <i class="fa fa-check"></i></p>
                        <p class="">Storyboard <i class="fa fa-check"></i></p>
                        <p class="">Sample Themes <i class="fa fa-check"></i></p>
                        <p class="">Custom Setting, Characters &amp; Graphics <i class="fa fa-check"></i></p>
                        <p class="">Animation Effects &amp; Visualization <i class="fa fa-check"></i></p>
                        <p class="">Voice - Over &amp; Sound Effects (All accents) (M/F) <i class="fa fa-check"></i></p>
