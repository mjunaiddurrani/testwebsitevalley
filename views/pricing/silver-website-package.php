...
<title>SILVER WEBSITE PACKAGE - THE WEB FOUNDERS</title>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£<?= cutPrice($silverWebsite);?></span>  £<?= $silverWebsite?>   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for strong startups that are looking to build a unique brand identity to help them stand apart from their competitors with a strong brand presence and strong brand revamps for companies.</span></h6>
      ...
      <div class="sub-list ">
          <div class="table-packages bronze">
            ...
            <div class="contentScroll innerContentScroll">
                          ...
                          <p class="">Dedicated Project Manager <i class="fa fa-check"></i></p>
