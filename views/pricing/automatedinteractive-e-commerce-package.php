...
<title>AUTOMATED E-COMMERCE PACKAGE - THE WEB FOUNDERS</title>
...
<div class="container pt-5">
   <div class="col-md-12">
        <h2 class="myheading">Automated E-Commerce Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Automated E-Commerce Package</h3>
          <h6><span class="old">£<?= cutPrice($automatedEcommerce);?></span>  £<?= $automatedEcommerce?>   <!-- <b>USD</b> --> <span class="contentScroll contentScroll-upper"><b class="monthss"></b>Suitable for strong/mid/large sized enterprises and startups who are looking to work with a strong R&D, Creative and Marketing team to help select every element towards their branding, create strong digital marketing and brand presence strategies and to compete with mid/large level enterprises to grow at faster pace and start off directly at the start of the food chain.</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <div class="contentScroll innerContentScroll">
                <p>Conceptual and Dynamic Website <i class="fa fa-check "></i></p>
                ...
                <p>Product Reviews <i class="fa fa-check "></i></p>
                ...
                <p>Sales &amp; Inventory Management <i class="fa fa-check "></i></p>
                <p>Jquery Slider <i class="fa fa-check "></i></p>
                <p>Free Google Friendly Sitemap <i class="fa fa-check "></i></p>
                <p>Custom Email Addresses <i class="fa fa-check "></i></p>
                <p>Complete W3C Certified HTML <i class="fa fa-check "></i></p>
                <p>Facebook Page Design <i class="fa fa-check "></i></p>
                <p>Twitter Page Design <i class="fa fa-check "></i></p>
                <p>YouTube Page Design <i class="fa fa-check "></i></p>
                <p>Instagram Page Design <i class="fa fa-check "></i></p>
                <p>Complete Deployment <i class="fa fa-check "></i></p>
