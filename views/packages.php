...
<head>
  ...
  <title>THE WEB FOUNDERS PACKAGES FOR THE BEST SERVICES.</title>
  <meta name="description" content="Check out our most affordable packages for the best services that we provide to your customers in detail so you may know the whole process.">
...
<body class="services">
  ...
  <section class="section1" style="background: url('images/banner/packages.jpg');">
    <div class="overlay"></div>
    <div class="container z-index-9 position-relative">
      <div class="text-center">
        <h2 class="font-18">              <p class="h3">Solutions carefully crafted to cater all kinds and sizes of enterprises.</p>
</h2>
        <h1 class="text-white font-60 font-w800">FROM ENTREPRENEUERS TO CORPORATE GIANTS</h1>
      </div>
    </div>
  </section>
	  ...
	  <div class="container text-dark">
        ...
        <div class="col-md-6">
          <div class="textOfSection3">
            ...
            Choose the plan that fulfills your needs best.
            </p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="row">
            <p class="text-secondary font-w300 line-height-32 font-22 p-5">Choose the plan that fulfils your needs best. Our services are unrivalled by anyone in the market, and the same goes for our plans. Get the most out of what we offer. </p>
          </div>
        </div>
      </div>
	  	<div class="row">
