...
?>
<!-- 
<base href="<?= $requesMet.'://'.$_SERVER['HTTP_HOST'].'/dpweb/web/' ?>"> -->
<meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
            <div class="logo"><a href="index.html" title="The Web Founders"> </a></div>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 text-right">
            <div class="header-content">
              <div class="call-action"> 
              <span onclick="window.location.href=' book-a-call.html'" ><small><i class="fa fa-calendar" aria-hidden="true"></i></small>Book a Call</span> 
              <span><small><i class="fa fa-phone-square" aria-hidden="true"></i></small>+44 2038 834810</span>
               </div>
              <div class="main-menu">
                <nav id="nav">
                  <ul id="navigation">
              ...
              <div class="container">
                <div class="logo-inside"><a href="index.html" title="The Web Founders"></a></div>
...
<section class="floating_wrap">
  ...
  <div class="row">         <div class="col-xs-12 col-sm-6 col-md-6 margin-bottom-20 field-mergedright">
      <input type="text" autocomplete="off" class="form-control" placeholder="Full Name" name="name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Full Name'" pattern="^[A-Za-z ]+$" maxlength="45" required="required">
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 margin-bottom-20 field-mergedleft">
      <input type="email" autocomplete="off" class="form-control" placeholder="Email" name="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="required">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20 field-mergedright">
      <input type="number" min="1" autocomplete="off" class="form-control" placeholder="phone" name="phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" maxlength="15" pattern="^[0-9]*$" required="">
    </div>
  <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20 field-mergedright">
     <textarea class="form-control" name="brief" placeholder="Your Project Specification" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Project Specification'" maxlength="250" pattern="^[A-Za-z ]+$" required></textarea>
    </div>
      ...
      <div class="d_t">
        <div class="d_c">
          <div class="actions wow fadeInDown" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInDown;">
            <div class="row">
              <div class="col-12 col-md-6 paddingtop customize-fields">
                <div class="banr-txt">
                  <h2>Creativity is the fruit of imagination.</h2>
                  ...
                  <a href="javascript:;" onclick="$zopim.livechat.window.toggle()" class="start">Chat Now To Avail Discounts</a>
                  ...
                  <div class="banner-bot">
                    <ul>
                      <li>
                        <a href="javascript:;">
                          <img src="img/rateimg.png">
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;">
                          <img src="img/gpartner.png">
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;">
                          <img src="img/binsider.png">
                        </a>
                      </li>
                    </ul>
                  </div>
...
<section class="mainform visibleweb">
  ...
  <div class="row">         
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20 field-mergedright">
      <input type="number" min="1" autocomplete="off" class="form-control" placeholder="Phone Number" name="phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" maxlength="15" pattern="^[0-9]*$" required="">
    </div>
  <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20 field-mergedright">
     <textarea class="form-control" name="brief" placeholder="Your Project Specification" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Project Specification'" maxlength="250" pattern="^[A-Za-z ]+$" required></textarea>
    </div>
...
<section class="section-padding service-detail service-drop-down hideweb">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 margin-bottom-10 ">
      <input type="number" min="1" autocomplete="off" class="form-control" placeholder="Phone Number" name="number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" maxlength="15" pattern="^[0-9]*$" required />
    </div>
    <div class="col-md-12 col-xs-12 margin-bottom-10">
      ...
      <textarea class="form-control" name="description" placeholder="Talk about your project" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Description'" maxlength="250" pattern="^[A-Za-z ]+$" required></textarea>
    </div>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_1.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_1.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_2.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_2.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_3.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_3.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_4.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_4.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_5.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_5.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_6.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_6.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_7.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_7.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_8.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_8.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_9.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_9.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_10.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_10.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_11.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_11.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_12.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_12.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/website/web_design_13.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/website/thumbnail/web_design_13.jpg">
                  </figure>
                </a>
              </li>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_2.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_2.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_3.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_3.jpg">
                  </figure>
                </a>
              </li>
              ...
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_4.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_4.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_5.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_5.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_6.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_6.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(1).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(1).jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(2).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(2).jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(3).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(3).jpg">
                  </figure>
                </a>
              </li>
              ...
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(4).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(4).jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(5).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(5).jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/logos/logo_1n-(6).jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/logos/logo_1n-(6).jpg">
                  </figure>
                </a>
              </li>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-16.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-16.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-15.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-15.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-14.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-14.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-13.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-13.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-12.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-12.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-11.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-11.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-10.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-10.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-9.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-9.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-8.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-8.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-7.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-7.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-6.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-6.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-5.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-5.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-4.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-4.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-3.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-3.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/branding/brand-2.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/branding/brand-2.jpg">
                  </figure>
                </a>
              </li>
            </ul>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_1.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_1.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_2.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_2.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_3.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_3.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_4.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_4.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_5.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_5.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/video/vid_6.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/video/vid_6.jpg">
                  </figure>
                </a>
              </li>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_1.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_1.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_2.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_2.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_3.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_3.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_4.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_4.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_5.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_5.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_6.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_6.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_7.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_7.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_8.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_8.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_9.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_9.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_10.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_10.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_11.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_11.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_12.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_12.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_13.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_13.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_14.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_14.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_15.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_15.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_16.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_16.jpg">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="/images/home/portfolio/mobileApp/app_design_17.jpg" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/images/home/portfolio/mobileApp/app_design_17.jpg">
                  </figure>
                </a>
              </li>
            ...
            <ul class="portfoliolist">
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/kt-afroblue-initial.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/kt-afroblue-initial-t.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/kt-walking-paws-initial.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/kt-walking-paws-initial-t.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/ms-torie-rhyan-custom-art.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/ms-torie-rhyan-custom-art-t.png">
                  </figure>
                </a>
              </li>
              ...
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/nk-amber-lynn-jonesextra.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/nk-amber-lynn-jonesextra-t.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/rajsehmi-sas.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/rajsehmi-sas-t.png">
                  </figure>
                </a>
              </li>
              <li class="border-box-effect">
                <a class="" data-fancybox="port" href="img/port/tinarehman-sas-approved.png" tabindex="-1">
                  <figure>
                    <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/port/tinarehman-sas-approved-t.png">
                  </figure>
                </a>
              </li>
...
header #header-sroll .top-action .btn-line-fill{ color: #ffa739; }

#header-sroll.small .top-action .btn-line-fill{ color: #ffa739; }
      ...
      <div class="col-md-push-2 col-md-8 col-xs-12">
        ...
        <input type="text" name="name" class="jun name" value=""> 
          ...
          <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20 field-mergedright">
                <input type="number" min="1" autocomplete="off" class="form-control" placeholder="Phone Number" name="phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" maxlength="15" pattern="^[0-9]*$" required="required" />
              </div>
                      
            <div class="col-xs-12 col-sm-12 col-md-12 margin-bottom-20">
              <textarea class="form-control" name="brief" placeholder="Talk about your project" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Description'" maxlength="250" pattern="^[A-Za-z ]+$" required="required"></textarea>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                    ...
                    <div class="clearfix">
                      <div class="address">
                        <ul>
                          <li><a href="services/Brand-Development.html">Brand Development</a></li>
                          <li><a href="web.html">Web Design and Development</a></li>
                          <li><a href="services/Back-End-Development.html">Back-End Development</a></li>
                  ...
                  <div class="col-md-6 col-lg-6 col-xs-12">
                    <ul>
                      ...
                      <li><a href="services/2D-%26-3D-illustration-animation.html">2D & 3D Illustration</a></li>
                    </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-4 col-lg-4 col-xs-12"> 
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                ...
                <div class="col-md-12 col-lg-12 col-xs-12 col-md-2">
        <!--            <ul>-->
        <!--  <li>Sign up for free newsletters & get more of The Web Founders delivered to you.</li>-->
        <!--  <li class=newsletter>-->
        <!--    <div class=subscribe>-->
        <!--      <form method="POST" id="subscribe_form" action="https://www.thewebfounders.co.uk/subscribe" data-loader=".loader_quote_subscribe_fold">-->
        <!--        <input name="email" type="email"  onblur='this.placeholder="Email"'onfocus='this.placeholder=""'placeholder="Email" required>-->
        <!--        <input name="page" type="hidden" value="https://www.thewebfounders.co.uk/web">-->
        <!--        <input type="hidden" name="_token" value="Y4M3O5ExAzJNiAwHGILiTbGx68DBsuoa49enunvp">-->
        ...
        <ul class="footer-group">
        <li><a target="_blank" href="https://www.facebook.com/thewebfounders/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://twitter.com/thewebfounders"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://www.linkedin.com/company-beta/thewebfounders"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://www.instagram.com/thewebfounders/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://medium.com/@thewebfounders"><i class="fa fa-medium" aria-hidden="true"></i></a> </li>
        <li><a target="_blank" href="https://www.pinterest.com/thewebfounders/"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://vimeo.com/thewebfounders"><i class="fa fa-vimeo" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://dribbble.com/thewebfounders"><i class="fa fa-dribbble" aria-hidden="true"></i></a> </li>
      </ul>
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                <div class="panel-body">
                 <div class="col-md-12 col-lg-12 col-xs-12 col-md-2">
                    <ul>
          <li>Sign up for free newsletters & get more of The Web Founders
            delivered to you.</li>
          <li class=newsletter>
            <div class=subscribe>
              <form method="POST" id="subscribe_form" action="https://www.thewebfounders.co.uk/subscribe" data-loader=".loader_quote_subscribe_fold">
  ...
  <section class="copright">
    <div class="container">
      <div class="row">
        ...
        <a href="https://www.thewebfounders.co.uk/terms">Terms of Service</a></span> </div>
      </div>
    </div>
  </section>
</footer>
