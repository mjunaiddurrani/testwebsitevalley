...
<?php for($i=1;$i<=20;$i++):?>
    ...
    <div class="col-lg-3 col-md-4 col-xs-6 screen">
        <a href="images/home/portfolio/website/web_design_<?=$i?>.jpg" class="fancybox" rel="ligthbox">
            <img src="images/home/portfolio/website/web_design_<?=$i?>.jpg" class="img-responsive">
        </a>
    </div>
<?php endfor;?>
<?php for($i=1;$i<=18;$i++):?>
...
<?php for($i=1;$i<=18;$i++):?>
    ...
    <div class="col-lg-3 col-md-4 col-xs-6 screen">
        <a href="images/home/portfolio/ecom/<?=$i?>b.png" class="fancybox" rel="ligthbox">
        <img  src="images/home/portfolio/ecom/<?=$i?>b.png" class="image-responsive"  alt="">
