...
<section class="our-banner inner-banner combo-banner text-center pkg-detail-banner">
        ...
        <div class="container">
            <div class="caption" data-aos="fade-up" data-aos-duration="800">
                ...
                <h3>E-Commerce Identity Package</h3>
                <h1>World Class Ecommerce Development Solutions With The Ecommerce Identity Package</h1>
        ...
        <div class="container">
            <div class="row" data-aos="fade-up" data-aos-duration="800">
                <div class="col-sm-4">
                    <div class="pack">
                        <div class="head">
                            <h3>E-Commerce Identity <br> Package
                            </h3>
                            <img src="../assets/images/pack-log-4.png" alt="">
                        </div>
                        <h2><sup>$</sup>1699 <span>$3399 <strike>Only</strike></span></h2>
...
<a href="tel:6282709920" class="various grad-btn desktopbtn">Start Project</a>  
                ...
                <div class="col-md-8">
                    ...
                    <h5>E-Commerce Identity Package</h5>
                    <p>Think you need to capture the right audience for your online ecommerce store? With our Ecommerce Identity Package, we’ve got you covered. With our Identity ecommerce package, we provide you everything that you need from your e-store.
                        <br><br> With the Identity Ecommerce Package, you get nothing but the best ecommerce website with unlimited pages. Capacity to upload over 500 of your best products also comes included. Together with the complete shipping module
                        and payment integration, this is all you need to get started with a successful business online.
                        <br><br> With the Ecommerce Identity package, we give you the perfect blend of services needed to push your brand to the limit.</p>
